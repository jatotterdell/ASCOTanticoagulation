...
Although the therapeutic dose arm was introduced on 2021-10-14 very few participants (4) enrolled in India were randomised to the therapeutic arm due to country specific availabilities. Therefore, a second sensitivity analysis is performed where the population excludes India. In this set, the amount of missingness is relatively high (compared to the outcome rate).
