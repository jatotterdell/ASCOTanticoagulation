...
A summary of the primary outcome by each of the baseline covariates pre-specified to be included in the primary model are presented in the appendix (@sec-app-primary-outcome-model-cov).
...
#| fig-cap: |
#|   Summary (point - median, block - 0.75 CrI, line - 0.95 CrI) 
#|   of odds ratio posteriors for epoch and site effects for
