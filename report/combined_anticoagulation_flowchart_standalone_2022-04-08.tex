...
\begin{tikzpicture}[auto,
    ...
    % row
    \node [block_center] (screened) {Screened for platform eligibility\\ \textbf{2,203}};
   \node [block_blank] (blank0) [below=3cm of screened] {};
   \node [block_left] (pineligible) [right=0.5cm of blank0] {\textbf{604}\h Ineligible for platform: \\
     \begin{tabular}{@{\hskip 10pt}r@{\hskip 3pt}l}
       \textbf{169} & Did not consent \\
       \textbf{155} & Not in the patients best interests \\
       \textbf{59} & No eligible domains \\
       \textbf{58} & Not committed to active treatment \\
       \textbf{40} & First positive test - over 14 days ago \\
       \textbf{31} & No signs or symptoms \\
       \textbf{29} & First symptoms - over 14 days ago \\
