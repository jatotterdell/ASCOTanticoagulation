...
mdrws$OR <- exp(rbind(mdrws$CtrtAgelt60, mdrws$CtrtAgegt60))
rownames(mdrws$OR) <- c("Age < 60", "Age 60+")
colnames(mdrws$OR) <- c("Intermediate", "Standard plus aspirin", "Therapeutic")
# Compare treatment effects across regions
mdrws$compare <- sweep(mdrws$OR, 2, mdrws$OR[1, ], FUN = "/")
...
mdrws$OR <- exp(rbind(mdrws$CtrtDSFSlt7, mdrws$CtrtDSFSgt7))
rownames(mdrws$OR) <- c("DSFS <= 7", "DSFS > 7")
colnames(mdrws$OR) <- c("Intermediate", "Standard plus aspirin", "Therapeutic")
# Compare treatment effects across regions
mdrws$compare <- sweep(mdrws$OR, 2, mdrws$OR[1, ], FUN = "/")
...
mdrws$OR <- exp(rbind(mdrws$noSteroids, mdrws$recSteroids))
rownames(mdrws$OR) <- c("No", "Yes")
colnames(mdrws$OR) <- c("Intermediate", "Standard plus aspirin", "Therapeutic")
# Compare treatment effects across regions
mdrws$compare <- sweep(mdrws$OR, 2, mdrws$OR[1, ], FUN = "/")
...
compdat <- expand_grid(
  Contrast = labs,
  `Received corticosteroids` = c("No (ref)", "Yes"),
) %>%
  mutate(Posterior = c(mdrws$compare)) %>%
  summarise_posterior() %>%
  select(-`Pr(OR > 1/1.1)`)
...
mdrws$OR <- exp(rbind(mdrws$noRem, mdrws$recRem))
rownames(mdrws$OR) <- c("No", "Yes")
colnames(mdrws$OR) <- c("Intermediate", "Standard plus aspirin", "Therapeutic")
# Compare treatment effects across regions
mdrws$compare <- sweep(mdrws$OR, 2, mdrws$OR[1, ], FUN = "/")
...
compdat <- expand_grid(
  Contrast = labs,
  `Received remdesivir` = c("No (ref)", "Yes"),
) %>%
  mutate(Posterior = c(mdrws$compare)) %>%
  summarise_posterior() %>%
  select(-`Pr(OR > 1/1.1)`)
...
mdrws$OR <- exp(rbind(mdrws$noantiviral, mdrws$antiviral))
rownames(mdrws$OR) <- c("No", "Yes")
colnames(mdrws$OR) <- c("Intermediate", "Standard plus aspirin", "Therapeutic")
# Compare treatment effects across regions
mdrws$compare <- sweep(mdrws$OR, 2, mdrws$OR[1, ], FUN = "/")
...
compdat <- expand_grid(
  Contrast = labs,
  `Received other antiviral` = c("No (ref)", "Yes"),
) %>%
  mutate(Posterior = c(mdrws$compare)) %>%
  summarise_posterior() %>%
  select(-`Pr(OR > 1/1.1)`)
...
mdrws$OR <- exp(rbind(mdrws$inrange, mdrws$outrange, mdrws$unknown))
rownames(mdrws$OR) <- c("No", "Yes", "Unknown")
colnames(mdrws$OR) <- c("Intermediate", "Standard plus aspirin", "Therapeutic")
# Compare treatment effects across regions
mdrws$compare <- sweep(mdrws$OR, 2, mdrws$OR[1, ], FUN = "/")
...
compdat <- expand_grid(
  Contrast = labs,
  `D-dimer out of range` = c("No (ref)", "Yes", "Unknown"),
) %>%
  mutate(Posterior = c(mdrws$compare)) %>%
  summarise_posterior() %>%
  select(-`Pr(OR > 1/1.1)`)
...
mdrws$OR <- exp(rbind(mdrws$noAspirin, mdrws$Aspirin))
rownames(mdrws$OR) <- c("No", "Yes")
colnames(mdrws$OR) <- c("Intermediate", "Standard plus aspirin", "Therapeutic")
# Compare treatment effects across regions
mdrws$compare <- sweep(mdrws$OR, 2, mdrws$OR[1, ], FUN = "/")
...
compdat <- expand_grid(
  Contrast = labs,
   `Patient taking aspirin` = c("No (ref)", "Yes"),
) %>%
  mutate(Posterior = c(mdrws$compare)) %>%
  summarise_posterior() %>%
  select(-`Pr(OR > 1/1.1)`)
