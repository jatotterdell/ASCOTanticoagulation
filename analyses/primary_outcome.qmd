...
save_tex_table(
  decision_quantity_summary_table(c("Standard" = rvar(1), res$drws$OR[1:3]), "latex"),
  "outcomes/primary/primary-model-acs-itt-decision-table")
decision_quantity_summary_table(
  c("Standard" = rvar(1), res$drws$OR[1:3])
)
```
...
#|   standard dose or intermediate dose arms (ACS-ITT-intermediate).
save_tex_table(
  make_po_table(
...
#|   standard dose plus aspirin arm was available (ACS-ITT-aspirin).
save_tex_table(
  make_po_table(
...
#| tbl-cap: Primary outcome summary for participants randomised whilst the
#|   standard dose plus aspirin arm was available (ACS-ITT-therapeutic).
save_tex_table(
  make_po_table(
