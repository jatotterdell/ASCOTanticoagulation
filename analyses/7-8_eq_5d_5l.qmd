...
out <- counts %>% kable(format = format, digits = 2, booktabs = TRUE, linesep = "", align = "lrrrrr", longtable = TRUE,
  ...
  group_rows(paste0("C1, missing = ",   missing[["missing_state"]][missing[["CAssignment"]] == "C1"]), 1, 12) %>%
  group_rows(paste0("C2, missing = ",   missing[["missing_state"]][missing[["CAssignment"]] == "C2"]), 13, 24) %>%
  group_rows(paste0("C3, missing = ",   missing[["missing_state"]][missing[["CAssignment"]] == "C3"]), 25, 36) %>%
  group_rows(paste0("C4, missing = ",   missing[["missing_state"]][missing[["CAssignment"]] == "C4"]), 37, 48) %>%
...
>>>>>>> 46ab926eda5be737fc3eb328c1c1ffcd0dc21e40
...
make_table()  %>% kable_styling()
make_table(format = "latex", fn = "7-8_eq5d_utility.tex")
