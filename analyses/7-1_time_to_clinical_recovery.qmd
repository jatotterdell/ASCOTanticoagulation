...
as_tibble(drws$gamma_epoch, rownames = "day") %>% 
  pivot_longer(V1:V2) %>%
  ggplot(., 
         aes(xdist=value, y = fct_inorder(day))) + 
  facet_wrap( ~ name, scales = "free_x") +
...
pth <- file.path("outputs", "figures", "outcomes", "primary", "7-1-primary-model-acs-itt-epoch-site-recovery.pdf")
ggsave(pth, p1, width = 6, height = 4.5)
pth <- file.path("outputs", "figures", "outcomes", "primary", "7-1-primary-model-acs-itt-epoch-site-death.pdf")
